...
test: test.cpp client.h bitvector.o disk.o diskmanager.o partitionmanager.o filesystem.o
	$(CC)  -o test test.cpp bitvector.o disk.o diskmanager.o partitionmanager.o filesystem.o

clean: 
	rm -f bitvector.o disk.o diskmanager.o partitionmanager.o filesystem.o driver1 driver2 driver3 driver4 driver5 driver6 driver bitvector_driver DISK1 test driver1.txt driver2.txt driver3.txt driver4.txt driver5.txt driver6.txt
